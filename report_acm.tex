...
We describe an overall of the architecture of the sensors and the actuators but the aim of the project is about the Central Unit, the main component of the system.
...
We thus describe all the inference needed.

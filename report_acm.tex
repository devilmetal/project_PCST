...
All our actuators depends on electrical input to work. The main idea to perform remote activation of actuators depend of a single element that we will name "Smart Swith".
